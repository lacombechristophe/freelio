...
| Modèles, séquences, workflows | **Partiel** | modèles HTML assainis avec aperçu, étapes et délais, inscriptions consenties, pause/arrêt, arrêt sur réponse ou opposition, triggers lead/devis/e-mail/portail/intervention, tâches, notifications, changement de statut et journal idempotent | pas d’éditeur graphique, de branches imbriquées ou de test A/B |
...
| Marketing automation/campagnes | **Partiel** | séquences ciblées consenties, règles CRM événementielles, segments actifs/statiques, scoring explicable, statistiques d’envoi et arrêt immédiat sur retrait/réponse | campagnes de masse, A/B, attribution avancée et gouvernance de délivrabilité à compléter ou externaliser |
...
| Portail client | **Disponible** | liens hashés temporaires/révocables, identité issue du profil, suivi de projets/interventions, devis/factures/fichiers, messages et demandes de rendez-vous | recette avec de vrais clients, politique de durée et notification e-mail du lien à formaliser |
...
| PostgreSQL | **Disponible** | schéma miroir, client dédié et seize migrations versionnées validées sans dérive sur base vierge et sur reprise des onze migrations antérieures avec données conservées ; réparation idempotente documentée pour l’ancien schéma Vercel | hébergeur, haute disponibilité, sauvegardes et restauration à mettre en service |
...
| CI/CD | **Partiel** | workflow GitHub Actions : génération Prisma, types, lint, 96 tests unitaires, build et Playwright PostgreSQL sur base isolée | infrastructure externe et secrets de production restent à administrer |
