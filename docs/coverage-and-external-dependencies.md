...
| CI/CD | **Partiel** | workflow GitHub Actions : génération Prisma, types, lint, 110 tests unitaires, build et Playwright sur base isolée ; scénario mobile rendu déterministe après résolution du ticket partagé | infrastructure externe et secrets de production restent à administrer |
