...
| Achats fournisseur | **Partiel** | commande, ligne, délai, rattachement chantier et numérotation | pas d'accusé fournisseur, d'approbation, de relance ni de commande multi-lignes riche dans l'UI actuelle |
