...
| CI/CD | **Partiel** | workflow GitHub Actions : génération Prisma, types, lint, 98 tests unitaires, build et Playwright PostgreSQL sur base isolée | infrastructure externe et secrets de production restent à administrer |
