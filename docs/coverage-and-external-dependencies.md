...
| Centre de support et SLA | **Disponible** | files filtrables, charge par responsable, priorité, cible de résolution par défaut ou personnalisée, dépassement, chronologie e-mail du ticket, rattachement de fil, réponse depuis le dossier, notes internes et chaîne de dossiers | horaires ouvrés, jours fériés, routage automatique, macros et politiques SLA contractuelles restent à paramétrer selon les engagements réels |
...
| PostgreSQL | **Disponible** | schéma miroir, client dédié et 33 migrations versionnées ; réparation idempotente documentée pour l’ancien schéma Vercel | hébergeur, haute disponibilité, sauvegardes et restauration à mettre en service |
...
| CI/CD | **Partiel** | workflow GitHub Actions : génération Prisma, types, lint, 167 tests unitaires, build et Playwright sur base isolée ; déclenchement push, PR ou manuel | fournisseurs externes et secrets associés restent à administrer |
