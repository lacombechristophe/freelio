...
| Modèles, séquences, workflows | **Partiel** | modèles HTML assainis avec aperçu, étapes et délais, jours ouvrés, fenêtre/fuseau d’envoi, statistiques par étape, inscriptions consenties, pause/arrêt, arrêt sur réponse ou opposition, triggers lead/devis/e-mail/portail/intervention, tâches, notifications, changement de statut et journal idempotent | pas encore d’étapes manuelles dans les séquences, d’éditeur graphique, de branches imbriquées ou de test A/B |
...
| PostgreSQL | **Disponible** | schéma miroir, client dédié et vingt migrations versionnées ; réparation idempotente documentée pour l’ancien schéma Vercel | hébergeur, haute disponibilité, sauvegardes et restauration à mettre en service |
