...
| PostgreSQL | **Disponible** | schéma miroir, client dédié et quinze migrations versionnées validées sans dérive sur base vierge et sur reprise des onze migrations antérieures avec données conservées | hébergeur, haute disponibilité, sauvegardes et restauration à mettre en service |
