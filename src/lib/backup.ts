...
const COMPANY_TABLE_SPECS: TableSpec[] = [
  ...
  direct("ServiceTicketNote"),
  direct("ServiceDiagnosticGuide"),
  direct("ServiceTicketDiagnostic"),
...
const LEGACY_UNREPRESENTED_TABLES = [
  ...
  "GoodsReceipt", "StockReservation", "Equipment", "ServiceTicket", "ServiceTicketNote", "ServiceDiagnosticGuide", "ServiceTicketDiagnostic", "KnowledgeArticle", "SatisfactionSurvey", "SatisfactionRequest", "SavedView", "FieldIntervention", "InterventionReservation",
