...
const LEGACY_UNREPRESENTED_TABLES = [
  ...
  "GoodsReceipt", "StockReservation", "Equipment", "ServiceTicket", "ServiceTicketNote", "KnowledgeArticle", "SatisfactionSurvey", "SatisfactionRequest", "SavedView", "FieldIntervention", "InterventionReservation",
