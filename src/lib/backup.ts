...
const COMPANY_TABLE_SPECS: TableSpec[] = [
  ...
  direct("KnowledgeArticle"),
  direct("SatisfactionSurvey"),
  direct("SatisfactionRequest"),
...
const LEGACY_UNREPRESENTED_TABLES = [
  ...
  "GoodsReceipt", "StockReservation", "Equipment", "ServiceTicket", "KnowledgeArticle", "SatisfactionSurvey", "SatisfactionRequest", "FieldIntervention", "InterventionReservation",
  ...
  "EmailSequenceEnrollment", "EmailDelivery", "EmailThread", "EmailMessage", "EmailEvent", "CommunicationChannel", "LeadScoringRule", "MarketingSegment", "MarketingSegmentMember", "MarketingCampaign", "MarketingCampaignAsset", "AutomationWorkflow", "AutomationRun",
]
