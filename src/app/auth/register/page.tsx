      ...
      <section className="flex min-h-screen flex-col px-6 py-5 sm:px-10 sm:py-7 lg:px-14 xl:px-20">
        ...
        <div className="my-auto w-full max-w-[470px] py-12 lg:self-center">
          ...
          <form action={formAction} className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <label className="sm:col-span-2 flex items-start gap-3 rounded-xl border border-freelio-line bg-freelio-canvas p-3.5 text-sm leading-5"><input name="acceptTerms" type="checkbox" required className="mt-0.5 size-4 accent-freelio-accent" /><span>J’accepte les <Link href="/conditions" className="font-medium text-freelio-accent hover:underline">conditions d’utilisation</Link> et la <Link href="/conformite" className="font-medium text-freelio-accent hover:underline">politique de confidentialité</Link>.</span></label>
