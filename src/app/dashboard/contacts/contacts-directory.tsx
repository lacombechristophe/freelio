...
export function ContactsDirectory({ contacts, savedViews }: { contacts: ContactRow[]; savedViews: SavedView[] }) {
  ...
  return <div className="space-y-4">
    ...
    {visible.length ? <div className="workspace-panel overflow-hidden">
