...
export default async function ContactsPage() {
  ...
  return <div className="workspace-page"><PageHeader className="workspace-page-header" eyebrow="CRM" title="Contacts" description="Tous les interlocuteurs, leurs coordonnées, leur entreprise et leur niveau d’engagement dans une vue exploitable." /><ContactsDirectory contacts={contacts} savedViews={views ?? []} /></div>
}
