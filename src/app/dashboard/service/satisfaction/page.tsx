...
export default async function SatisfactionPage() {
  ...
  return <div className="workspace-page"><PageHeader eyebrow="Service" title="Satisfaction client" description="Mesurez le CSAT, le NPS et l’effort client avec des invitations sécurisées rattachées aux dossiers réels." /><SatisfactionCenter initialData={data} /></div>
}
