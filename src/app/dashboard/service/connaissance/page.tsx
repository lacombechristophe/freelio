...
export default async function KnowledgePage() {
  ...
  return <div className="space-y-7"><PageHeader eyebrow="Service" title="Base de connaissances" description="Centralisez les procédures internes et publiez uniquement les réponses validées dans l’espace client." /><KnowledgeCenter initialData={data} /></div>
}
